...
class Researcher
  ...
  def research
    while !@complete
      ...
      if new_message.start_with?('search:')
        query = new_message[7..-1].strip
      ...
      elsif new_message.start_with?('visit:')
        url = new_message[6..-1].strip
